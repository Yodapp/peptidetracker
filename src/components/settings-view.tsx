...
export function SettingsView({ store, update, syncState, retrySync, syncError, userEmail }: { store: PeptimeStore; update: React.Dispatch<React.SetStateAction<PeptimeStore>>; syncState: "local"|"syncing"|"synced"|"error"; retrySync: () => void; syncError: string | null; userEmail?: string }) {
